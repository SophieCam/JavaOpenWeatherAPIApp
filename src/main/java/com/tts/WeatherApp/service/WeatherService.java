...
public class WeatherService {
    //reads our API key from app.props
    @Value("${api_key}")
    ...
    public Response getForecast(String zipCode){
        ...
        //RestTemplate comes from spring web, its a container for web requests
        RestTemplate restTemplate = new RestTemplate();
        try{
            ZipCode passedZipCode= new ZipCode();
            passedZipCode.setZipCode(zipCode);
    ...
    public List<ZipCode> getLatestZipCodeSearches() {
        ...
        zipCodeRepository.findAll().forEach(zipCodes::add); //(zipCodes:: add) is a method reference
